@echo off
title ButterCMD Winrar Cracker
Setlocal enabledelayedexpansion
::------------ Interface ------------::
color 0e
echo.
echo before using please CD into where your file is located 
echo used for cracking winrar / zip files 
echo do not use for anything else 
echo press any button to continu
timeout /t 8 >nul
::-----------------------------------::
